...
func (BundleTransmissionRequest) GenerateBundle(original Bundle) (*Bundle, error) {
...
// https://www.rfc-editor.org/rfc/rfc9171.html#name-bundle-transmission
func (bun Bundle) Transmission(btr BundleTransmissionRequest) error {
	// Step 1:
